...
//   const userEnteredData = inputBox.value.toLowerCase();
//   const emptyArray = productsData.filter((data) => {
//     return data.name.toLowerCase().includes(userEnteredData);
//   });
...
//   const selectedProduct = productsData.find((data) => data.name === element.textContent);
//   // Hiển thị thông tin chi tiết sản phẩm hoặc thực hiện hành động mong muốn ở đây
